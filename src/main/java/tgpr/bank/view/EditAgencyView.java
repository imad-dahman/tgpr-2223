...
import tgpr.bank.controller.EditAgencyController;
import tgpr.bank.model.Agency;

import java.util.List;

public class EditAgencyView extends DialogWindow {
    private final EditAgencyController controller;

    private final Agency agency;

    public EditAgencyView(EditAgencyController controller, Agency agency) {
